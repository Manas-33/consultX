...
export function createClientRequestedEvent(
  ...
  clientRequestedEvent.parameters.push(
    new ethereum.EventParam(
      "reqAccepted",
      ethereum.Value.fromBoolean(reqAccepted)
    )
  )
  clientRequestedEvent.parameters.push(
    new ethereum.EventParam(
...
export function createExpertRequestAcceptedEvent(
  ExpertAddress: Address,
  ExpertRequestStatus: boolean,
  ExpertName: string,
  Expertise: string,
  ExpertFees: BigInt
): ExpertRequestAccepted {
  let expertRequestAcceptedEvent = changetype<ExpertRequestAccepted>(
    newMockEvent()
  )

  expertRequestAcceptedEvent.parameters = new Array()

  expertRequestAcceptedEvent.parameters.push(
    new ethereum.EventParam(
      "ExpertAddress",
      ethereum.Value.fromAddress(ExpertAddress)
    )
  ...
  expertRequestAcceptedEvent.parameters.push(
    new ethereum.EventParam(
      "ExpertRequestStatus",
      ethereum.Value.fromBoolean(ExpertRequestStatus)
    )
  )
  expertRequestAcceptedEvent.parameters.push(
    new ethereum.EventParam("ExpertName", ethereum.Value.fromString(ExpertName))
  ...
  return expertRequestAcceptedEvent
}
...
export function createExpertRequestedEvent(
  ...
  expertRequestedEvent.parameters.push(
    new ethereum.EventParam(
      "RequestStatus",
      ethereum.Value.fromBoolean(RequestStatus)
    )
  )
  expertRequestedEvent.parameters.push(
    new ethereum.EventParam("ExpertName", ethereum.Value.fromString(ExpertName))
