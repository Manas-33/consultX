...
export class ExpertRequestAccepted extends ethereum.Event {
  get params(): ExpertRequestAccepted__Params {
    return new ExpertRequestAccepted__Params(this);
  }
}

export class ExpertRequestAccepted__Params {
  _event: ExpertRequestAccepted;

  constructor(event: ExpertRequestAccepted) {
    this._event = event;
  }
  ...
  get ExpertRequestStatus(): boolean {
    return this._event.parameters[1].value.toBoolean();
  }
...
export class Contract__AllClientRequestesResult {
  value0: Address;
  value1: Address;
  value2: boolean;
  value3: BigInt;
...
export class Contract__AllRequestesResult {
  value0: Address;
  value1: boolean;
  value2: BigInt;
...
export class Contract__OneAdminMapResult {
  value0: Address;
  value1: string;
  value2: string;
...
export class Contract__OneClientMapResult {
  value0: Address;
  value1: string;
  value2: string;
  value3: string;
...
export class Contract__OneExpertMapResult {
  value0: Address;
  value1: string;
  value2: string;
  value3: string;
...
export class Contract extends ethereum.SmartContract {
  ...
  AllClientRequestes(param0: Address): Contract__AllClientRequestesResult {
    ...
    return new Contract__AllClientRequestesResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBoolean(),
      result[3].toBigInt(),
  ...
  try_AllClientRequestes(
    param0: Address,
  ): ethereum.CallResult<Contract__AllClientRequestesResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Contract__AllClientRequestesResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBoolean(),
        value[3].toBigInt(),
  ...
  AllRequestes(param0: Address): Contract__AllRequestesResult {
    let result = super.call(
      "AllRequestes",
    ...
    return new Contract__AllRequestesResult(
      result[0].toAddress(),
      result[1].toBoolean(),
      result[2].toBigInt(),
    );
  ...
  try_AllRequestes(
    param0: Address,
  ): ethereum.CallResult<Contract__AllRequestesResult> {
    let result = super.tryCall(
      "AllRequestes",
      "AllRequestes(address):(address,bool,uint256)",
      [ethereum.Value.fromAddress(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__AllRequestesResult(
        value[0].toAddress(),
        value[1].toBoolean(),
        value[2].toBigInt(),
      ),
  ...
  GetSmartContractBalance(): BigInt {
    let result = super.call(
      "GetSmartContractBalance",
      "GetSmartContractBalance():(uint256)",
      [],
    );
  ...
  try_GetSmartContractBalance(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "GetSmartContractBalance",
      "GetSmartContractBalance():(uint256)",
      [],
  ...
  OneAdminMap(param0: Address): Contract__OneAdminMapResult {
    let result = super.call(
      "OneAdminMap",
    ...
    return new Contract__OneAdminMapResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString(),
    );
  ...
  try_OneAdminMap(
    param0: Address,
  ): ethereum.CallResult<Contract__OneAdminMapResult> {
    let result = super.tryCall(
      "OneAdminMap",
      "OneAdminMap(address):(address,string,string)",
      [ethereum.Value.fromAddress(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__OneAdminMapResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString(),
      ),
  ...
  OneClientMap(param0: Address): Contract__OneClientMapResult {
    let result = super.call(
      "OneClientMap",
    ...
    return new Contract__OneClientMapResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_OneClientMap(
    param0: Address,
  ): ethereum.CallResult<Contract__OneClientMapResult> {
    let result = super.tryCall(
      "OneClientMap",
      "OneClientMap(address):(address,string,string,string,string)",
      [ethereum.Value.fromAddress(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__OneClientMapResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString(),
        value[3].toString(),
  ...
  OneExpertMap(param0: Address): Contract__OneExpertMapResult {
    let result = super.call(
      "OneExpertMap",
      "OneExpertMap(address):(address,string,string,string,string,uint256)",
      [ethereum.Value.fromAddress(param0)],
    );

    return new Contract__OneExpertMapResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_OneExpertMap(
    param0: Address,
  ): ethereum.CallResult<Contract__OneExpertMapResult> {
    let result = super.tryCall(
      "OneExpertMap",
      "OneExpertMap(address):(address,string,string,string,string,uint256)",
      [ethereum.Value.fromAddress(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__OneExpertMapResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString(),
        value[3].toString(),
